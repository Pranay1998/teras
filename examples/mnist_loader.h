...
#define TRAIN_IMAGE "examples/data/train-images.idx3-ubyte"
#define TRAIN_LABEL "examples/data/train-labels.idx1-ubyte"
#define TEST_IMAGE "examples/data/t10k-images.idx3-ubyte"
#define TEST_LABEL "examples/data/t10k-labels.idx1-ubyte"
